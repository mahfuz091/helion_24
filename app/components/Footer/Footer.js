          ...
          <div className='col-span-1 md:col-span-1  xl:col-span-3'>
            ...
            <div className='socials'>
              ...
              <Link target='blank' href='https://x.com/HelionEdge'>
                <div className='w-[45px] h-[45px] rounded-full border-[#ffffff40] border-[2px] flex items-center justify-center hover:bg-[#38b6ff] hover:border-none cursor-pointer'>
          ...
          <div className='col-span-1 md:col-span-1  xl:col-span-3'>
            ...
            <div className='flex flex-col '>
              ...
              <Link href='contact'>
                <button
                  type='submit'
                  className=' lets_talk_btn mt-3   w-full transition-all duration-300 hover:bg-title-color'
                >
                  Lets Talk
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
