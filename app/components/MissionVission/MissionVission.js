            ...
            <div className="container 2xl:max-w-[1180px]">
                <div className="grid md:grid-cols-2 grid-cols-1 xl:gap-[60px] gap-[30px] lg:items-center mb-[40px]">
                    ...
                    <div>
                        ...
                        <p>At Helion Edge, we aim to revolutionize asset management by integrating cutting-edge technology with robust regulatory frameworks, providing institutional investors with unmatched transparency, security, and performance.</p>
                    </div>
                </div>
                <div className="grid md:grid-cols-2 grid-cols-1 xl:gap-[60px] gap-[30px] lg:items-center">
                    ...
                    <div className='md:order-1'>
                        ...
                        <p>To be the leading non-custodial asset management platform, trusted globally by institutional investors for our innovation and reliability.</p>
                    </div>
                </div>
            </div>
        </section>
